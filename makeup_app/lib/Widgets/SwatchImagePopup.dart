...
class SwatchImagePopup extends StatefulWidget {
  ...
  final OnStringAction onImgAdded;

  SwatchImagePopup(this.swatchId, this.otherImgIds, this.onImgAdded);
                      ...
                      Align(
                        ...
                        child: Container(
                          ...
                          child: globalWidgets.getFlatButton(
                            ...
                            onPressed: () async {
                              String imgId = await allSwatchesStorageIO.addImg(file: ImagePicker.img!, otherImgIds: widget.otherImgIds, swatchId: widget.swatchId, labels: labels);
                              _hasInit = false;
                              Navigator.pop(context);
                              widget.onImgAdded(imgId);
                            },
                            child: Align(
                              alignment: Alignment.center,
                              child: Text(

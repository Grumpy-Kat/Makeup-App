...
void setRoutes() {
  routes = {
    ...
    '/paletteScannerScreen': (context, [shouldReset = false]) => PaletteScannerScreen(reset: shouldReset ?? false),
    ...
    '/addPaletteDividerScreen': (context, [shouldReset = false]) => AddPaletteDividerScreen(reset: shouldReset ?? false),
    '/addCustomPaletteScreen': (context, [shouldReset = false]) => AddCustomPaletteScreen(reset: shouldReset ?? false),
    '/addPresetPaletteScreen': (context, [shouldReset = false]) => AddPresetPaletteScreen(reset: shouldReset ?? false),

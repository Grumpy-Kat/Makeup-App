...
TextStyle get primaryTextSmall => TextStyle(color: primaryTextColor, fontSize: 15.0, fontWeight: FontWeight.normal, decoration: TextDecoration.none, fontFamily: fontFamily);
TextStyle get accentTitle => TextStyle(color: accentTextColor, fontSize: 30.0, fontWeight: FontWeight.bold, fontFamily: fontFamily);
TextStyle get accentText => TextStyle(color: accentTextColor, fontSize: 20.0, decoration: TextDecoration.none, fontFamily: fontFamily);
TextStyle get accentTextSmall => TextStyle(color: accentTextColor, fontSize: 15.0, decoration: TextDecoration.none, fontFamily: fontFamily);

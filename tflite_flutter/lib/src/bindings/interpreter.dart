...
Pointer<TfLiteInterpreter> Function(Pointer<TfLiteModel> model, Pointer<TfLiteInterpreterOptions> optionalOptions)? tfLiteInterpreterCreate =
    tflitelib?.lookup<NativeFunction<_TfLiteInterpreterCreate_native_t>>('TfLiteInterpreterCreate').asFunction();
...
void Function(Pointer<TfLiteInterpreter>)? tfLiteInterpreterDelete =
    tflitelib?.lookup<NativeFunction<_TfLiteInterpreterDelete_native_t>>('TfLiteInterpreterDelete').asFunction();
...
int Function(Pointer<TfLiteInterpreter>)? tfLiteInterpreterGetInputTensorCount =
    tflitelib?.lookup<NativeFunction<_TfLiteInterpreterGetInputTensorCount_native_t>>('TfLiteInterpreterGetInputTensorCount').asFunction();
...
Pointer<TfLiteTensor> Function(Pointer<TfLiteInterpreter> interpreter, int inputIndex)? tfLiteInterpreterGetInputTensor =
    tflitelib?.lookup<NativeFunction<_TfLiteInterpreterGetInputTensor_native_t>>('TfLiteInterpreterGetInputTensor').asFunction();
...
/// REQUIRES: 0 <= input_index < TfLiteInterpreterGetInputTensorCount(tensor)
/*TfLiteStatus*/
int Function(Pointer<TfLiteInterpreter> interpreter, int inputIndex, Pointer<Int32> inputDims, int inputDimsSize)? tfLiteInterpreterResizeInputTensor =
    tflitelib?.lookup<NativeFunction<_TfLiteInterpreterResizeInputTensor_native_t>>('TfLiteInterpreterResizeInputTensor').asFunction();
...
int Function(Pointer<TfLiteInterpreter>)? tfLiteInterpreterAllocateTensors =
    tflitelib?.lookup<NativeFunction<_TfLiteInterpreterAllocateTensors_native_t>>('TfLiteInterpreterAllocateTensors').asFunction();
...
/// AllocateTensors()).
/*TfLiteStatus*/
int Function(Pointer<TfLiteInterpreter>)? tfLiteInterpreterInvoke =
    tflitelib?.lookup<NativeFunction<_TfLiteInterpreterInvoke_native_t>>('TfLiteInterpreterInvoke').asFunction();
...
int Function(Pointer<TfLiteInterpreter>)? tfLiteInterpreterGetOutputTensorCount =
    tflitelib?.lookup<NativeFunction<_TfLiteInterpreterGetOutputTensorCount_native_t>>('TfLiteInterpreterGetOutputTensorCount').asFunction();
...
Pointer<TfLiteTensor> Function(Pointer<TfLiteInterpreter> interpreter, int outputIndex)? tfLiteInterpreterGetOutputTensor =
    tflitelib?.lookup<NativeFunction<_TfLiteInterpreterGetOutputTensor_native_t>>('TfLiteInterpreterGetOutputTensor').asFunction();

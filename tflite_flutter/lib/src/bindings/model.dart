...
Pointer<TfLiteModel> Function(Pointer<Void> data, int size)? tfLiteModelCreateFromBuffer =
    tflitelib?.lookup<NativeFunction<_TfLiteModelCreateFromBuffer_native_t>>('TfLiteModelCreate').asFunction();
...
Pointer<TfLiteModel> Function(Pointer<Utf8> path)? tfLiteModelCreateFromFile =
    tflitelib?.lookup<NativeFunction<_TfLiteModelCreateFromFile_native_t>>('TfLiteModelCreateFromFile').asFunction();

typedef _TfLiteModelCreateFromFile_native_t = Pointer<TfLiteModel> Function(
    Pointer<Utf8> path);

/// Destroys the model instance.
void Function(Pointer<TfLiteModel>)? tfLiteModelDelete =
    tflitelib?.lookup<NativeFunction<_TfLiteModelDelete_native_t>>('TfLiteModelDelete').asFunction();

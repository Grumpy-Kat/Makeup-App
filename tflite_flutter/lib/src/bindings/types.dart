...
class TFLGpuDelegateOptions extends Struct {
  ...
  external Pointer<TFLGpuDelegateOptions> addressOf;

  /// Generated by @ffi.struct annotation
  external static int sizeOf();

  static TFLGpuDelegateOptions allocate(bool allowPrecisionLoss, TFLGpuDelegateWaitType waitType) =>
      calloc.allocate<TFLGpuDelegateOptions>(sizeOf()).ref
...
class TfLiteGpuDelegateOptionsV2 extends Struct {
  ...
  external Pointer<TfLiteGpuDelegateOptionsV2> addressOf;

  /// Generated by @ffi.struct annotation
  external static int sizeOf();

  static TfLiteGpuDelegateOptionsV2 allocate(
      ...
      ) => calloc.allocate<TfLiteGpuDelegateOptionsV2>(sizeOf()).ref

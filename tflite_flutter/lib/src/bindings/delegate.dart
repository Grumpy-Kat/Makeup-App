...
/// .wait_type = kPassive,
Pointer<TfLiteDelegate> Function(Pointer<TFLGpuDelegateOptions> options)? tflGpuDelegateCreate =
    tflitelib?.lookup<NativeFunction<_TFLGpuDelegateCreate_native_t>>('TFLGpuDelegateCreate').asFunction();

typedef _TFLGpuDelegateCreate_native_t = Pointer<TfLiteDelegate> Function(Pointer<TFLGpuDelegateOptions> options);

/// Destroys a delegate created with `TFLGpuDelegateCreate` call.
void Function(Pointer<TfLiteDelegate>)? tflGpuDelegateDelete =
    tflitelib?.lookup<NativeFunction<_TFLGpuDelegateDelete_native_t>>('TFLGpuDelegateDelete').asFunction();
...
Pointer<TfLiteDelegate> Function(Pointer<TfLiteGpuDelegateOptionsV2> options)? tfLiteGpuDelegateV2Create =
    tflitelib?.lookup<NativeFunction<_TfLiteGpuDelegateV2Create_native_t>>('TfLiteGpuDelegateV2Create').asFunction();
...
void Function(Pointer<TfLiteDelegate>)? tfLiteGpuDelegateV2Delete =
    tflitelib?.lookup<NativeFunction<_TFLGpuDelegateV2Delete_native_t>>('TfLiteGpuDelegateV2Delete').asFunction();

typedef _TFLGpuDelegateV2Delete_native_t = Void Function(
    Pointer<TfLiteDelegate> delegate);

/// Creates TfLiteGpuDelegateV2 with default options
Pointer<TfLiteGpuDelegateOptionsV2> Function()? tfLiteGpuDelegateOptionsV2Default =
    tflitelib?.lookup<NativeFunction<_TfLiteTfLiteGpuDelegateOptionsV2Default_native_t>>('TfLiteGpuDelegateOptionsV2Default').asFunction();
...
Pointer<TfLiteDelegate> Function()? tfLiteStatefulNnApiDelegateCreate =
    tflitelib?.lookup<NativeFunction<_TfLiteStatefulNnApiDelegateCreate_native_t>>('TfLiteStatefulNnApiDelegateCreate').asFunction();
...
void Function(Pointer<TfLiteDelegate>)? tfLiteStatefulNnApiDelegateDelete =
    tflitelib?.lookup<NativeFunction<_TfLiteStatefulNnApiDelegateDelete_native_t>>('TfLiteStatefulNnApiDelegateDelete').asFunction();
